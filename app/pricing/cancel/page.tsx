...
export default function CheckoutCancelPage() {
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(180deg,#07111f 0%,#0d1321 100%)', color: '#f5f7fa', fontFamily: 'Inter, Arial, sans-serif', display: 'grid', placeItems: 'center', padding: '32px' }}>
      <section style={{ width: 'min(660px,100%)', background: '#0b192b', border: '1px solid rgba(86,160,255,.22)', borderRadius: 16, padding: 36, textAlign: 'center' }}>
        ...
        <p style={{ margin: '0 auto 24px', color: '#a8b5c6', fontSize: 16, lineHeight: 1.7, maxWidth: 540 }}>No new TenantIQ subscription was created from this checkout session. You can return to pricing whenever you are ready.</p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/pricing" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '12px 18px', borderRadius: 8, background: '#4c8dff', color: '#07111f', textDecoration: 'none', fontWeight: 800 }}><ArrowLeft size={16}/> Return to pricing</a>
