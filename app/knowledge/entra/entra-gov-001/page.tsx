...
export default async function AccessReviewsKnowledgePage() {
      ...
      <div style={{ width: 'min(980px,100%)', margin: '0 auto', padding: '38px 20px 72px' }}>
        ...
        <header style={{ margin: '24px 0 28px' }}>
          <div style={{ display: 'flex', gap: 9, flexWrap: 'wrap', alignItems: 'center', marginBottom: 12 }}>
            <span style={{ color: '#6eb5ff', fontSize: 12, fontWeight: 900, letterSpacing: '.08em' }}>ENTRA-GOV-001</span>
            <span style={{ border: '1px solid rgba(108,190,255,.28)', background: 'rgba(108,190,255,.08)', color: '#8bcaff', borderRadius: 999, padding: '4px 9px', fontSize: 11, fontWeight: 850 }}>Entra ID</span>
            <span style={{ color: '#9eb0c4', fontSize: 11 }}>Identity Governance</span>
          </div>
          <h1 style={{ fontSize: 'clamp(38px,6vw,58px)', lineHeight: 1.03, margin: '0 0 14px' }}>Access Reviews</h1>
          <p style={{ margin: 0, color: '#aeb8c8', fontSize: 17, lineHeight: 1.65, maxWidth: 820 }}>
            TenantIQ uses ENTRA-GOV-001 to assess access reviews in Entra ID. This guidance is evidence-bound: TenantIQ should explain only what the selected assessment observed and should not infer tenant configuration that is not present in the finding evidence.
          </p>
        </header>
        ...
        <div style={{ display: 'grid', gap: 16 }}>
          <section style={panel}>
            ...
            <p style={{ margin: 0, color: '#b4c1cf', lineHeight: 1.7 }}>
              This check evaluates the TenantIQ control represented by access reviews and Identity Governance access reviews. A FAIL or WARNING means the observed configuration, coverage, inventory, or governance state requires review against the organization&apos;s approved Microsoft 365 security, compliance, operational, or governance baseline.
            </p>
          </section>
          ...
          <section style={panel}>
            ...
            <ul style={{ margin: 0, paddingLeft: 20, color: '#b4c1cf', lineHeight: 1.85 }}>
              <li>Check ID and title.</li>
              <li>Workload and category.</li>
              <li>Status and severity.</li>
              <li>TenantIQ evidence returned by the health check.</li>
              <li>Any counts, policy names, configuration values, objects, or scope explicitly present in the evidence.</li>
          ...
          <section style={panel}>
            ...
            <ol style={{ margin: 0, paddingLeft: 22, color: '#b4c1cf', lineHeight: 1.85 }}>
              <li>Confirm the finding is in scope for the tenant and workload.</li>
              ...
              <li>Document approved exceptions and ownership where the recommended baseline is intentionally not applied.</li>
              <li>Re-run the TenantIQ assessment after remediation to verify the finding state changed as expected.</li>
            </ol>
          </section>
          ...
          <section style={{ ...panel, display: 'flex', gap: 18, alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap' }}>
            <div>
              ...
              <h2 style={{ margin: '8px 0 6px', fontSize: 23 }}>Ask TenantIQ about ENTRA-GOV-001</h2>
              <p style={{ margin: 0, color: '#9fb0c2', lineHeight: 1.55, fontSize: 14 }}>Open the Knowledge Assistant and investigate Access Reviews against the selected assessment.</p>
            </div>
            <a href="/assistant?finding=ENTRA-GOV-001" style={{ display: 'inline-block', borderRadius: 10, padding: '12px 17px', background: '#2f87ff', color: '#fff', fontWeight: 900, textDecoration: 'none', whiteSpace: 'nowrap' }}>Ask about Access Reviews →</a>
          </section>
        </div>
      </div>
    </main>
