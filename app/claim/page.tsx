    ...
    <main className="claim-page">
      ...
      <section className="claim-card">
        ...
        {!loading && claim && <>
          ...
          <div className="claim-notice"><ShieldCheck size={18} style={{verticalAlign:'middle',marginRight:8}}/>The claim token is valid and the subscription/license record is confirmed. The actual ZIP is intentionally not public; the next deployment step will connect this page to private object storage and issue a short-lived download URL.</div>
          <div className="claim-actions"><a className="claim-button primary" href="/pricing"><LockKeyhole size={16}/> TenantIQ pricing</a><a className="claim-button" href="/">TenantIQ home</a></div>
        </>}
      </section>
    </main>
  );
